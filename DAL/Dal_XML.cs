...
namespace DAL
{
    class Dal_XML : IDAL
    {
        ...
        XElement ConvertStudent(BE.Student student)
        {
            ...
            {
                studentElement.Add(new XElement(item.Name, item.GetValue(student, null)));
            }
        ...
        XElement ConvertCourse(BE.Course course)
        {
            ...
            {
                courseElement.Add(new XElement(item.Name, item.GetValue(course, null)));
            }
        ...
        XElement ConvertStudentCourse(BE.StudentCourseAdapter studentCourse)
        {
            ...
            {
                studentCourseElement.Add(new XElement(item.Name, item.GetValue(studentCourse, null)));
            }
        ...
        public void AddStudentCourse(StudentCourseAdapter sc)
        {
            ...
            {
                throw new Exception(
                    "can not Register the course in the same year and the same semester more than once...");
            }
